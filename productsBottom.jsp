...
<title><fmt:message key="bottomlist"/></title>
</head>
<body>
<jsp:include page="menu.jsp"/>
<div class="jumbotron">
  <div class="container">
     <h1 class="display-3"><fmt:message key="bottomlist"/></h1>
  </div>
</div>
<div class="container">
   ...
   <div class="row" align="center">
    <%@ include file="dbconn.jsp" %>
     <%  /* DB로 부터 상품 정보 리스트 얻기 */
        ...
        ResultSet rs = null;
        String sql = "select * from productsBottom order by p_id";
...
if(recentProducts!=null) {
	for(int i=0;i<recentProducts.size();i++){
		...
		out.print("<li><a href='productsBottom.jsp?id="+recentProduct.getProductId()+"'>"
